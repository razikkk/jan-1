...
<nav className="bg-white w-full z-50 ">
  <div className="max-w-7xl mx-auto px-0 sm:px-8 lg:px-10">
    ...
    <div className="grid grid-cols-3 items-center h-22 bg-white lg:bg-transparent">
      ...
      <div className="hidden lg:flex items-center space-x-8">
        <Link 
          to="/" 
          className={`text-blacktransition-colors font-medium `}
        >
          {t('home')}
        </Link>
        ...
        <div className="relative group">
          <button className="flex items-center space-x-1 text-black transition-colors font-medium">
  ...
  >
   <img 
  src="Jana Marine-logo-bg.png" 
  alt="Jana Marine Logo" 
...
<div className="hidden lg:flex items-center justify-end flex-1 space-x-8">
  ...
  <div className="flex items-center space-x-8">
    <Link to="/news" className="text-black font-medium transition-colors">{t('news')}</Link>
    <Link to="/careers" className="text-black font-medium transition-colors">{t('careers')}</Link>
    <Link
  to="/contact"
...
>
  ...
  <div className="lg:hidden fixed inset-0 z-50 bg-white backdrop-blur-lg flex flex-col justify-between">
    ...
    <div className="pb-6 text-center text-gray-500 text-sm">
      © {new Date().getFullYear()} Jana Marine. All rights reserved.
    </div>
  </div>
)}
