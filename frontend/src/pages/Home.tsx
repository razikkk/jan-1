...
>
  ...
  className="
    ...
    pt-[180px]         /* 👉 push everything down on mobile */
    xs:pt-24
    sm:pt-0        /* 👉 remove padding from tablet onward */
  "
>

  {/* ABSOLUTE IMAGE — so moving it won’t push the text */}
  <img
  src="/sc.png"
...
/>
  ...
  <h2
    className="
      ...
      -mt-8               /* 👈 Pull heading upward to overlap image */
      xs:-mt-12
      sm:-mt-20
      md:-mt-28
      lg:-mt-32
  ...
  <p
    ...
    "
  >
    From Land, Air & Sea – Jana Marine is everywhere to serve you.
  </p>
</div>
