...
const Services = () => {
  const services = [
    ...
    },
    {
      icon: Ship,
      title: 'Sea Freight',
      description: 'Reliable and cost-effective sea freight services for global import and export. We manage containerized, bulk, and project cargo with end-to-end coordination.',
      features: [
    ...
    },
    {
      icon: Plane,
      title: 'Air Freight',
      description: 'Fast, secure, and efficient air freight services for time-critical cargo. We ensure smooth customs clearance and global delivery coverage.',
      features: [
        'Priority & Express Air Cargo',
